...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::conversation::get_composer_catalog,
            commands::conversation::search_composer_files,
            ...
            commands::workspace::get_draft_thread_state,
            commands::workspace::save_draft_thread_state,
