...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::terminal::open_environment_terminal,
            commands::terminal::write_environment_terminal,
            commands::terminal::resize_environment_terminal,
            commands::terminal::close_environment_terminal,
